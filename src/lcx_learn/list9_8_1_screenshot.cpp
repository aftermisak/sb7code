...
class my_application9_8_1 : public sb7::application
{
public:
	...
	void render(double currentTime)
	{
		...
		glBindFramebuffer(GL_READ_FRAMEBUFFER, fbo);//bind for read
		unsigned* data = new unsigned[512 * 512];
		float* depthData = new float[512 * 512];
		unsigned* stencilData = new unsigned[512 * 512];
		glReadPixels(0, 0, 512, 512, GL_RGBA, GL_UNSIGNED_BYTE, data);
		glReadPixels(0, 0, 512, 512, GL_DEPTH_COMPONENT, GL_FLOAT, depthData);
		glReadPixels(0, 0, 512, 512, GL_STENCIL_INDEX, GL_UNSIGNED_INT, stencilData);
		int i = 1;
		++i;
	}
private:
...
//DECLARE_MAIN(my_application9_8_1);